  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Master 9 must-know stock chart patterns — head & shoulders, double tops, cup & handle, flags and triangles — with bite-sized lessons and quick quizzes."
        path="/learn/patterns"
        jsonLd={{
        ...
        {mode === "menu" && (
          <>
            ...
            <p className="text-muted-foreground mt-2 mb-6">
              Bite-sized, Duolingo-style lessons. Tap through 9 must-know patterns, then test yourself with a quick quiz.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-3 mb-8">
              ...
              >
                ...
                <div className="text-lg font-bold mb-1">Learn the 9 patterns</div>
